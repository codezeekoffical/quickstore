...
class AuthRepo {
  ...
  Future<Response> verifyPhone(String phone, String otp,SignUpBody signUpBody) async {
    return await apiClient.postData(AppConstants.VERIFY_PHONE_URI, {"phone": phone, "otp": otp,"f_name":signUpBody.fName,"l_name":signUpBody.lName,"email":signUpBody.email,
