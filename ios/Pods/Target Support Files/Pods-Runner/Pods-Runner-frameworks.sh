...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/image_compression_flutter/image_compression_flutter.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/phone_number/phone_number.framework"
